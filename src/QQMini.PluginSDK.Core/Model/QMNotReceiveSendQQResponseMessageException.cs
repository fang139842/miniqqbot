...
namespace QQMini.PluginSDK.Core.Model
{
	...
	public class QMNotReceiveSendQQResponseMessageException : QMException
	{
		...
		/// </summary>
		public QMNotReceiveSendQQResponseMessageException ()
			: base (QMExceptionCodes.NotReceiveSendQQResponseMessage)
		{
		}
		/// <summary>
		/// 用序列化数据初始化 <see cref="QMNotReceiveSendQQResponseMessageException"/> 类的新实例
		/// </summary>
		...
		protected QMNotReceiveSendQQResponseMessageException (SerializationInfo info, StreamingContext context)
			: base (info, context)
		{
		}
		#endregion
